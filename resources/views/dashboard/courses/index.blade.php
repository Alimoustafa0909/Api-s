            ...
            <table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                @forelse($courses as $course)
                    <tr>
                        ...
                        <!--begin:: Image -->
                        <td>
                            <img src="{{ asset('storage/images/courses/' . $course['image']) }}" width="50"
                                 height="50">
                        </td>
                        <!--end:: Image -->
                        <!--begin::Name=-->
                        ...
                        <td>
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.courses.show',$course) }}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.courses.edit',$course) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
